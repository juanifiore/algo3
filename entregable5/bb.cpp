...
//	vector<int> swaps;
//	while(swap_a_b.size() >= 2){
//		int n = swap_a_b.size();
//		swaps.push_back(swap_a_b[n-1]);
//		swaps.push_back(swap_a_b[n-2]);
//		swap_a_b.pop_back();
//		swap_a_b.pop_back();
//	}
//	while(swap_b_a.size() >= 2){
//		int n = swap_b_a.size();
//		swaps.push_back(swap_b_a[n-1]);
//		swaps.push_back(swap_b_a[n-2]);
//		swap_b_a.pop_back();
//		swap_b_a.pop_back();
//	}
//
//	if(a%2==1){
//		swaps.push_back(swap_a_b[0]);
//		swaps.push_back(swap_a_b[0]);
//		swaps.push_back(swap_a_b[0]);
//		swaps.push_back(swap_b_a[0]);
//	}
